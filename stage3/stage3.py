...
def load_item_popularity(interactions_file='../stage1/filtered_interactions.csv', 
                         id_to_idx_file='../stage1/id_to_idx.pkl'):
    """从交互数据中计算商品流行度（点击次数）"""
    print("计算商品流行度...")
...
def load_stage3_data():
    ...
    # 加载商品统一表示
    item_reps = np.load('../stage2/item_unified_representations.npy')
...
def main():
    ...
    try:
        ...
        # 尝试加载最终模型
        model_path = '../stage2/final_model.pth'
